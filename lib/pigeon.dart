...
class ChannelRequest {
  ...
  static ChannelRequest _fromMap(Map<dynamic, dynamic> pigeonMap) {
    ...
    result.payload = RequestPayload._fromMap(pigeonMap['payload']);
    return result;
  }
}
...
class RequestPayload {
  ...
  static RequestPayload _fromMap(Map<dynamic, dynamic> pigeonMap) {
    ...
    result.credential = Credential._fromMap(pigeonMap['credential']);
    return result;
  }
}
...
class ChannelResponse {
  ...
  static ChannelResponse _fromMap(Map<dynamic, dynamic> pigeonMap) {
    ...
    result.error = Error._fromMap(pigeonMap['error']);
    return result;
  }
}
