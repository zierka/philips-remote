...
-(NSDictionary*)toMap {
  return [NSDictionary dictionaryWithObjectsAndKeys:(self.id ? self.id : [NSNull null]), @"id", (self.method ? self.method : [NSNull null]), @"method", (self.payload ? [self.payload toMap] : [NSNull null]), @"payload", nil];
}
@end
